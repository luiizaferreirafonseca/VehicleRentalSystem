...
public partial class PostgresContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbAccessory>(entity =>
        {
            ...
            entity.Property(e => e.DailyRate).HasPrecision(10, 2).HasColumnName("daily_rate");
        ...
        modelBuilder.Entity<TbPayment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentDate).HasDefaultValueSql("CURRENT_DATE").HasColumnType("timestamp with time zone").HasColumnName("payment_date");
            entity.Property(e => e.PaymentMethod).HasMaxLength(50).HasColumnName("payment_method");
            entity.Property(e => e.RentalId).HasColumnName("rental_id");
            entity.HasOne(d => d.Rental).WithMany(p => p.TbPayments).HasForeignKey(d => d.RentalId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_payment_rental");
        });
        ...
        modelBuilder.Entity<TbRating>(entity =>
        {
            ...
            entity.Property(e => e.RentalId).HasColumnName("rental_id");
            entity.HasOne(d => d.Rental).WithMany(p => p.TbRatings).HasForeignKey(d => d.RentalId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_rating_rental");
        });
        ...
        modelBuilder.Entity<TbRental>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("gen_random_uuid()").HasColumnName("id");
            entity.Property(e => e.ActualEndDate).HasColumnType("timestamp with time zone").HasColumnName("actual_end_date");
            entity.Property(e => e.DailyRate).HasPrecision(10, 2).HasColumnName("daily_rate");
            entity.Property(e => e.ExpectedEndDate).HasColumnType("timestamp with time zone").HasColumnName("expected_end_date");
            entity.Property(e => e.PenaltyFee).HasPrecision(10, 2).HasColumnName("penalty_fee");
            entity.Property(e => e.StartDate).HasDefaultValueSql("CURRENT_DATE").HasColumnType("timestamp with time zone").HasColumnName("start_date");
            entity.Property(e => e.Status).HasMaxLength(50).HasColumnName("status");
            entity.Property(e => e.TotalAmount).HasPrecision(10, 2).HasColumnName("total_amount");
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.Property(e => e.VehicleId).HasColumnName("vehicle_id");
            entity.HasOne(d => d.User).WithMany(p => p.TbRentals).HasForeignKey(d => d.UserId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_rental_user");
            entity.HasOne(d => d.Vehicle).WithMany(p => p.TbRentals).HasForeignKey(d => d.VehicleId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_rental_vehicle");
        });
        ...
        modelBuilder.Entity<TbRentalAccessory>(entity =>
        {
            ...
            entity.HasOne(d => d.Accessory).WithMany(p => p.TbRentalAccessories).HasForeignKey(d => d.AccessoryId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_ra_accessory");
            entity.HasOne(d => d.Rental).WithMany(p => p.TbRentalAccessories).HasForeignKey(d => d.RentalId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_ra_rental");
        });
